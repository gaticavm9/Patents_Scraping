...
/////////////////////////////// Search ///////////////////////////////
    ...
    await page.select(selectors.textField, "title")
    await page.waitForTimeout(5000);
    await page.type("#title", queryText);
    //Click en botón de busqueda y se espera hasta que cargue resultados
    await page.click("#advanced > div > div.ui-submit.ui-btn.ui-shadow.ui-btn-corner-all.ui-btn-up-c > button");
